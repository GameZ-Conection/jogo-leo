...
export default function EventModal() {
    ...
    useEffect(() => {
        ...
        // 🔥 controle de animação via ref (mais confiável)
        const talkingRef = { current: true };
    
        // 🔥 anima o NPC falando
        const talkingInterval = setInterval(() => {
            talkingRef.current = !talkingRef.current;
            setIsTalking(talkingRef.current); // força render seguro
        }, 250);
